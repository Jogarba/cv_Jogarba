...
function App() {
  ...
  return <div className="app">
    ...
    <main className="container">
      ...
      <section id="contacto" className="section"><SectionHeading path="~/contacto.sh" title="Hablemos" /><div className="contact-panel"><p className="contact-copy">Disponible para proyectos freelance y oportunidades de desarrollo web. Escríbeme y con gusto conversamos sobre tu proyecto.</p><div className="actions"><a className="button primary" href="https://mail.google.com/mail/?view=cm&amp;fs=1&amp;to=jogarba005%40gmail.com&amp;su=Consulta%20sobre%20proyecto%20web&amp;body=Hola%20Jos%C3%A9%2C%0A%0AMe%20gustar%C3%ADa%20conversar%20contigo%20sobre%20un%20proyecto%20web." target="_blank" rel="noreferrer">✉ Contactar por Gmail</a><a className="button secondary" href="https://github.com/Jogarba" target="_blank" rel="noreferrer">◉ Ver GitHub</a></div></div></section>
    </main>
